...
REGIONS = {
    ...
    # 인천
    "28125": "인천 제물포구", "28155": "인천 영종구", "28177": "인천 미추홀구", "28185": "인천 연수구",
    "28200": "인천 남동구", "28237": "인천 부평구", "28245": "인천 계양구", "28275": "인천 서구", "28290": "인천 검단구",
    "28710": "인천 강화군",
    # 광주 5개 구 — (2026-08-21) 광주·전남 통합으로 12xxx 로 편입되며 데이터가 열렸다.
    #   예전 주석대로 29xxx 는 전 구·전 월 0건이었는데, 코드 자체가 바뀐 것이었다.
    "12210": "광주 동구", "12240": "광주 서구", "12270": "광주 남구",
    ...
    "41150": "의정부시", "41171": "안양 만안구", "41173": "안양 동안구", "41192": "부천 원미구", "41194": "부천 소사구", "41196": "부천 오정구",
...
SIDO = {"11": "서울", "26": "부산", "27": "대구", "28": "인천", "30": "대전", "31": "울산", "36": "세종",
        "41": "경기", "51": "강원", "43": "충북", "44": "충남", "52": "전북", "12": "광주·전남",
        "47": "경북", "48": "경남", "50": "제주"}
...
def main():
    ...
    # 심층 백필 순서. data.go.kr 일일 한도 때문에 하루에 한두 시도씩밖에 못 채운다 →
    # 어느 지역을 먼저 완성할지가 곧 '어느 지역의 단지 랭킹을 먼저 볼 수 있나'가 된다.
    # (2026-08-10) 서울·경기는 이미 완료 → 부산을 맨 앞으로 당긴다(사용자 요청).
    PRIOR = {"26": 0, "11": 1, "41": 2, "28": 3, "27": 4}
