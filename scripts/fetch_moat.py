...
UNIV = [
    ...
    ("207940.KS", "삼성바이오로직스", "첨단바이오", "CDMO 캐파 세계 최대(78.4만L) + FDA 트랙레코드·장기계약 락인",  "XBI",  "SPDR S&P 바이오테크 ETF(XBI)"),
    ("LLY",       "일라이릴리",      "첨단바이오", "비만약 듀오폴리 선두 — 젭바운드 점유 57%",                   "XBI",  "SPDR S&P 바이오테크 ETF(XBI)"),
    ("NVO",       "노보노디스크",    "첨단바이오", "비만약 듀오폴리 — 경구 위고비 세계 최초 출시",                "XBI",  "SPDR S&P 바이오테크 ETF(XBI)"),
...
RISKS = {
    ...
    "NVO": "美 비만 처방 점유 릴리에 역전(약 4:6)·헤드투헤드 효능 열위(14% vs 20%) — 듀오폴리 내 2위 고착 리스크, 경구 선점(90%)이 방어선",
}
