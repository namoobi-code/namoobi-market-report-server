...
U = [
 ...
 ("fx","PHP=X","달러/필리핀 페소","Y",1,2), ("fx","VND=X","달러/베트남 동","Y",1,0),
 ("fx","MYR=X","달러/말레이시아 링깃","Y",1,4), ("fx","SAR=X","달러/사우디 리얄","Y",1,4),
 ("fx","AED=X","달러/UAE 디르함","Y",1,4), ("fx","ILS=X","달러/이스라엘 세켈","Y",1,4),
 ("fx","ARS=X","달러/아르헨티나 페소","Y",1,1), ("fx","COP=X","달러/콜롬비아 페소","Y",1,1),
 ("fx","HUF=X","달러/헝가리 포린트","Y",1,2), ("fx","RUB=X","달러/러시아 루블(역외)","Y",1,2),
 ...
 ("fx","BRL=X","달러/브라질 레알","Y",1,4), ("fx","TRY=X","달러/튀르키예 리라","Y",1,2),
 ("fx","UAH=X","달러/우크라이나 흐리브냐","Y",1,2),
