...
U = [
 ...
 ("us","^DJI","다우 산업","Y",1,2), ("us","YM=F","다우 선물","Y",1,2), ("us","^DJT","다우 운송","Y",1,2),
 ("us","^IXIC","나스닥 종합","Y",1,2),
 ("us","^NDX","나스닥 100","Y",1,2), ("us","NQ=F","E-mini 나스닥100 선물","Y",1,2),
 ("us","^GSPC","S&P 500","Y",1,2), ("us","ES=F","E-mini S&P500 선물","Y",1,2),
 ("us","^SOX","필라델피아 반도체","Y",1,2),
 ("us","^NYA","NYSE 종합","Y",1,2), ("us","^XAX","아멕스 종합","Y",1,2), ("us","^VIX","VIX","Y",1,2),
 ("us","^RUT","러셀 2000","Y",1,2), ("us","RTY=F","러셀2000 선물","Y",1,2),
 ...
 ("as","^STI","싱가폴 STI","Y",1,2), ("as","^KLSE","말레이시아 KLCI","Y",1,2), ("as","^JKSE","인도네시아 IDX종합","Y",1,2),
 ...
 ("cr","KRW-TRX","트론","U",1,0), ("cr","KRW-LINK","체인링크","U",1,0),
 ("cr","KRW-AVAX","아발란체","U",1,0), ("cr","KRW-SUI","수이","U",1,0),
 ("cr","KRW-USDT","테더(원화 프리미엄)","U",1,0),
]
