...
BATTLES = [
    ...
    ("llm", "A", "기업 LLM API 지출 점유 (AI 모델사)", "%", "반기",
     ...
     "가격 경쟁(중국 저가 모델)과 코딩 침투가 변수. 코딩 세그먼트는 앤트로픽 54% vs OpenAI 21%(2026 중반)",
     [("OpenAI", "MSFT(투자)"), ("앤트로픽", "IPO 예정(AMZN·GOOGL 투자)"), ("구글", "GOOGL"),
      ("메타 Llama", "META"), ("딥시크", "비상장(중국)")],
     [("2023-12", {"OpenAI": 50, "앤트로픽": 12}, "Menlo 2023 — OpenAI 압도기"),
      ("2024-12", {"OpenAI": 34, "앤트로픽": 24, "메타 Llama": 16, "구글": 12}, "Menlo 2024 보도치(E)"),
      ("2025-07", {"앤트로픽": 32, "OpenAI": 25, "구글": 20}, "Menlo 2025 중간 — 앤트로픽 첫 역전"),
      ("2026-07", {"앤트로픽": 40, "OpenAI": 27, "구글": 21, "메타 Llama": 9, "딥시크": 1},
       "Menlo 2026 — 기업 지출 $8.4B · 앤트로픽 3배 확대")],
