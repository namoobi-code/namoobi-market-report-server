...
BATTLES = [
    ...
    ("aicode", "A", "기업 AI 코딩 점유 (클로드코드·OpenAI·Copilot·Cursor)", "%", "반기",
     ...
     # (2026-09-02 시계열 확보) ⚠ 두 축 혼재 — 클로드코드·OpenAI 는 '모델사 축'(Menlo 기업 코딩
     # 워크로드), Copilot·Cursor 는 '유료 도구 제품 축'(구독 시장) — 분모가 달라 절대비교 금지,
     # 각자의 추세(Copilot 70→42 붕괴 vs 클로드코드 42→54 확대)를 보는 용도.
     [("2023-12", {"GitHub Copilot": 70}, "도구 축 — Copilot 단독 지배기(구독 3배 성장)"),
      ("2025-07", {"클로드코드(앤트로픽)": 42, "OpenAI": 21}, "Menlo 중간 실측 — 클로드 42% 첫 보도(TechCrunch)"),
      ("2025-12", {"클로드코드(앤트로픽)": 42, "GitHub Copilot": 42, "Cursor": 18},
       "모델 축 Menlo 42 · 도구 축 Copilot 42(70에서 붕괴)·Cursor 18 급부상"),
      ("2026-06", {"클로드코드(앤트로픽)": 54, "OpenAI": 21}, "Menlo — 클로드코드 과반(42→54)")],
     None, "모델 축=Menlo 기업 코딩(반기) · 도구 축=유료 구독 시장 보도 — 분모 다름(추세 비교용) + JetBrains 선호도 46/19/9 보조"),
