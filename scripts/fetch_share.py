...
BATTLES = [
    ...
    ("dram", "B", "D램 전체 매출 점유 (HBM 포함 — 범용 D램이 승부처)", "%", "분기",
     ...
     [("삼성전자", "005930.KS"), ("SK하이닉스", "000660.KS"), ("마이크론", "MU"), ("CXMT", "중국 上證(2026-07 상장)")],
     [("2025-06", {"SK하이닉스": 39}, "2Q25 — 당시 1위는 SK하이닉스(삼성·마이크론·CXMT 개별치 미확인, 추정 기입 안 함)"),
      ("2026-06", {"삼성전자": 39, "SK하이닉스": 26, "마이크론": 25, "CXMT": 10},
       "2Q26 실측 — 삼성 1위 탈환(2024년 수준 회복) · CXMT 첫 두 자릿수 · 마이크론 SK 와 1%p 차")],
     None, "Counterpoint Research 'AI Demand Reshapes DRAM Rankings in Q2 2026'(2026-08-03) — 매출 기준"),
