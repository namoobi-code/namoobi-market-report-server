...
BATTLES = [
    ...
    ("secarr", "B", "사이버보안 플랫폼 ARR (십억$) — '관리' 계층의 승자", "십억$", "분기",
     ...
     "개별 최적제품(best-of-breed)을 흡수하는 국면. 다만 이들 3사 합보다 큰 MS 보안 매출(2023년 이미 200억$ 돌파)이 "
     "E5 번들로 밑에서 잠식 중이라, 순수 보안업체의 성장이 '점유 확대'인지 '시장 확대에 편승'인지가 진짜 쟁점",
     [("팔로알토(NGS)", "PANW"), ("크라우드스트라이크", "CRWD"), ("지스케일러", "ZS")],
     [("2024-07", {"팔로알토(NGS)": 4.23, "크라우드스트라이크": 3.88, "지스케일러": 2.44},
       "각사 공시 YoY 역산(PANW +32%·CRWD +20%·ZS +25% 기준)"),
