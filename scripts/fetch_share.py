...
BATTLES = [
    ...
    ("aicode", "A", "기업 AI 코딩 점유 (클로드코드·OpenAI·Copilot·Cursor)", "%", "반기",
     ...
     [("2025-12", {"클로드코드(앤트로픽)": 42}, "Menlo — 6개월 전 시점 실측"),
      ("2026-06", {"클로드코드(앤트로픽)": 54, "OpenAI": 21}, "Menlo 기업 코딩 점유 — 클로드코드 과반")],
     None, "Menlo Ventures 기업 코딩 점유(반기) + JetBrains 개발자 선호도(연간) — Copilot·Cursor 는 점유 미공표라 선호도로 보조"),
