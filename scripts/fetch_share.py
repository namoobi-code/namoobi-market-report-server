...
BATTLES = [
    ...
    ("aicode", "A", "기업 코딩 워크로드 점유 (모델사 — 앤트로픽 vs OpenAI)", "%", "반기",
     "LLM 매출의 최대 침투 경로 — 앤트로픽 42→54% 급확대가 매출 성장의 엔진(기사: 매출 80% 기업). "
     "Menlo 기업 코딩 워크로드 실측(어느 모델로 코딩하나) — 도구 매출 점유는 아래 별도 배틀",
     [("앤트로픽(클로드)", "IPO 예정"), ("OpenAI", "MSFT(투자)")],
     [("2025-07", {"앤트로픽(클로드)": 42, "OpenAI": 21}, "Menlo 중간 실측 — 첫 보도(TechCrunch)"),
      ("2025-12", {"앤트로픽(클로드)": 42, "OpenAI": 21}, "Menlo State of AI — 유지"),
      ("2026-06", {"앤트로픽(클로드)": 54, "OpenAI": 21}, "Menlo — 과반 돌파(42→54)")],
