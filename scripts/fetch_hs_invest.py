...
EVENTS = [
    {"hs": "8504", "d": "2026-09-05",
     "txt": "⚡ 전력망 슈퍼사이클 — 피크아웃은 시기상조(한경MONEY·미래에셋 계통연계 원데이터). "
            "미국 계통연계 대기열 1,543GW=30년치(연 연결 52GW뿐·신청 564GW/년) · 전력기기 수요 2025 357→2028 648GW(연 +22%) · "
            "변압기 수급 2030년까지 공급 CAGR 3.4% vs 수요 5.9%(수요가 캐파 28% 상회) · 노후교체 기저수요 연 $100억",
     "est": "이 행(8504) 반영: 미국행 수출이 주력이라 장기 우상향 구조(E) — 232조 관세 개편으로 대형 변압기 실효관세 28.7→15%(~27.12)로 "
            "오히려 유리. 단 명암 갈림: 345kV+ 초고압(신청 증가·765kV 개화)은 강세, 145kV 이하는 2023년부터 하락세. "
            "국내 4사 미국 캐파는 점유율 추이 탭 '미국 변압기 캐파' 배틀 참조 · 평가 기준은 증설 실적화되는 2028~29년"},
    {"hs": "1902", "d": "2026-09-05",
     "txt": "🍜 라면 생산 캐파 3건 — 방향이 갈린다(이코노미스트 K라면 커버스토리). "
            "①농심 부산 녹산 수출전용 공장 10월 말 완공(수출용 라면 연 12억개로 확대) "
            "②삼양 중국 자싱 공장 내년 1월 완공(2,072억 · 전체 캐파 +40%) ③오뚜기 美 캘리포니아 2028 가동",
     "est": "반영 예상: ①녹산은 수출전용이라 이 행(1902)에 직접 유입 — 4Q26부터 완만한 증가, 풀가동 시 상당폭(E). "
            "②③은 현지생산 전환이라 반대 방향 — 자싱 가동 후 중국행 수출이 현지생산으로 대체될 수 있음(중국은 라면 수출 최대 시장권). "
            "순효과는 녹산(+) vs 자싱 대체(−)의 시차 싸움 — 4Q26~1H27 이 행의 기울기로 검증"},
