  ...
  function renderLegend(){
    ...
    {const rn=$('scr_revnote'); if(rn){
      const g = mkt==='us' ? [
        ...
        ['영업익추정 리비전 30일·90일','영업이익 컨센서스 추정치의 30·90일 전 대비 변화율(일별 스냅샷 차분). <b>30일: 스냅샷이 30일 미만이면 쌓인 만큼(최소 7일, 적재 시작 2026-08-09) 부분 창으로 제공 — 09-08부터 정식 30일 창</b>. <b>90일=2026-11-07~ 유효</b>(부분 창 없음)'],
