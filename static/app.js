...
(function(){
  ...
  // 탭 전환
  const panes=['p_welcome','p_daily','p_db','p_ai','p_ta','p_auto','p_fire','p_screener','p_vis','p_cal','p_etf','p_estate','p_global','p_trends','p_hobby','p_sub','p_pf','p_re'];  // p_sub: 청약 탭 (sub.js) · p_pf: (2026-08-23) Portfolio 탭 (pf.js) · p_re: (2026-08-23) RE 예측 탭 (re.js) — 여기 안 넣으면 탭 눌러도 빈 화면(실측)
