...
fetch('/api/report').then(r=>r.json()).then(R=>{
  ...
  $$('nav_d').innerHTML=[['d1','1 뉴스'],['d2','2 캘린더'],['d316','3.1.6 FactSet'],['d317','3.1.7 M7'],['d3112','3.1.12 심리'],['d32','3.2 한국'],['d321','3.2.1 수급'],['d322','3.2.2 종목수급'],['d323','3.2.3 테마'],['d323s','반도체·AI'],['s32','3.2.4·5 KRX브리프'],
