...
function renderDefense(){
  ...
  $('ex_df_cards').innerHTML=`<div style="display:flex;gap:10px;flex-wrap:wrap">
    ...
    ${card('📜 대형 계약 이력 (계약 기준 · 시점 병기)',[
      '한화: 폴란드 K9 364문 <b>6.6조</b>(22.8·23.12) · 천무 288대 <b>12.6조</b>(22.11·24.4·25.11) + 이집트(22.2)·핀란드 K9 추가 9,400억(26.4)·에스토니아 천무(26.5)',
      '로템: 폴란드 K2 1차 180대 4.5조(22.8) + 2차 180대 <b>9조(25.8 · 단일 역대최대 · 현지생산 포함)</b>',
      'LIG: 천궁-II 중동 3연타 — UAE 4.1조(2022) → 사우디 4.25조(2024) → 이라크 3.7조(2025)',
      'KAI: FA-50 폴란드 48대 4조(22.9) · 말레이시아 18대 1.2조(2023) · 필리핀 12대 추가 1조(2025)',
      '<span class="note">📌 미국 첫 진출(K9MH · 26.6)은 위 93류 행 수주 메모 참조</span>'],'#0f766e')}
